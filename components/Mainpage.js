...
function Mainpage() {
  ...
  return (
   <div className='flex-col w-full h-full  bg-red-200'>
      ...
      <div className="flex h-1/2 w-full bg-green-600">
        <div className='w-1/3 border-2 border-orange-500'> <DailyReach /></div>
        <div className='w-1/3 border-2 border-orange-500'> <Growth /></div>
       <div className='w-1/3 border-2 border-orange-500'>  <GotoDjango /></div>
      </div>
   </div>
  )
}
