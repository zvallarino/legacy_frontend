...
function Header() {
  ...
  return (
    ...
    <div className= "flex items-center justify-center">
            <div className='bg-white flex items-center justify-center p-2 px-4 rounded-md shadow-sm text-black my-2' >
    ...
    <div className="bg-white my-2 flex items-center justify-center p-2 px-4 rounded-md shadow-sm text-black text-sm mx-8">
        <p>
