...
<div className = "flex  w-full h-1/6 mt-28">
   ...
   <div className='flex w-4/6 flex-col '>
        <div className= "">
                <div className='border-b-2 border-black' >
                    ...
                    <div className="flex flex-col title text-4xl items-center">
                            <h1 className='text-4xl text-slate-800 font-bold'>Extraction Hub</h1>
                            <SiDatabricks className={` ${screenType === 'laptop' ? 'text-4xl' : 'text-8xl'} text-slate-800 ]my-2`}  />
        ...
        <div className="">
            <p className={` ${screenType === 'laptop' ? 'text-xs' : 'text-sm'} text-black mt-2`}>
